/*
4) Теплее ли в ближайшем городе? (async)
...
async function checkNeihboringCities(cityName, numberOfNeighbors = 5) {
    try {
        const coordOfYourCity = await getCoord(cityName);
        const cityes = await getCityesNeighbors(coordOfYourCity, numberOfNeighbors);
